# Generated by Django 4.2.4 on 2023-10-23 13:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('home', '0024_remove_following_profile_remove_friend_profile_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friends', models.ManyToManyField(related_name='my_followers', to='home.friend')),
        ...
        migrations.AddField(
            model_name='friend',
            name='profile',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='all_friends', to='home.profile'),
        ),
        migrations.CreateModel(
            name='Following',
            fields=[
